...
" Syntastic statusline configuration - MOVED TO AFTER PLUGINS LOAD
...
augroup json_autocmd
    autocmd!
    autocmd FileType json set foldcolumn=2
...
augroup json_autocmd
    autocmd!
    autocmd FileType .template set foldcolumn=3
